  ...
  class WorkspacesBar extends PanelMenu.Button {
    ...
    _update_ws() {
      ...
      for (let ws_index = 0; ws_index < this.ws_count; ++ws_index) {
        ...
        if (ws_index == this.active_ws_index) this.ws_box.label.style_class = 'desktop-label-active';
        else this.ws_box.label.style_class = 'desktop-label-inactive';
